...
const css = [
	...
	".dshn-readme{font-size:12.5px;line-height:1.7;white-space:pre-wrap;word-break:break-word;color:var(--dsw-alias-label-primary,#222);max-height:220px;overflow:hidden;position:relative}",
...
function Links({ res }) {
	...
	if (info.latestDetail?.tarball) links.push({
		label: t("tarball"),
		href: info.latestDetail.tarball
	});
	links.push({
		label: t("npmPage"),
		href: npmPage
...
function DepBlock({ title, deps }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		className: "dshn-dep-list",
		children: t("depsNone")
	}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: "dshn-dep-list",
		children: entries.map(([k, v]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("code", { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: k }),
			"@",
			v
		] }, k))
	})] });
...
function PackageDetail({ res, watched, onWatch, watchBusy, notice }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dshn-card-title",
				children: t("depsTitle")
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshn-meta",
				style: { gridTemplateColumns: "1fr" },
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DepBlock, {
						title: t("depsRuntime"),
						deps: detail?.dependencies
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DepBlock, {
						title: t("depsPeer"),
						deps: detail?.peerDependencies
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DepBlock, {
						title: t("depsDev"),
						deps: detail?.devDependencies
					})
				]
			})]
		}),

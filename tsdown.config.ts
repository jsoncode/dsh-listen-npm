/**
 * dsh-listen-npm —— tsdown 构建配置（对齐 dsh-jenkins 的双产物方案）。
 *
 * 两个产物：
...
const clientConfig: UserConfig = {
  ...
  // __ModuleLoader__ 工厂包装（与 dsh-jenkins 相同的 banner/intro/footer 方案）：
  // 产物整体位于 factory 函数体内，顶部 require(...) 解析到 factory 参数（seed 表）。
  banner: `window.__ModuleLoader__.load({ id: 'dsh-listen-npm', factory: (require) => {
